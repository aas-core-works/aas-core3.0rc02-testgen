...
def main() -> int:
    ...
    if Step.DOCTEST in selects and Step.DOCTEST not in skips:
        ...
        for pth in (repo_root / "aas_core3_0_rc02_testgen").glob("**/*.py"):
    ...
    if (
        ...
        print(
            "Checking that aas_core3_0_rc02_testgen/__init__.py and setup.py coincide..."
        )
        exit_code = call_and_report(
            verb="check that aas_core3_0_rc02_testgen/__init__.py and setup.py coincide",
            cmd=[
                sys.executable,
        ...
        print(
            "Skipped checking that aas_core3_0_rc02_testgen/__init__.py and "
            "setup.py coincide."
        )
